...
<script type="text/javascript" src="js/smoothscroll.js"></script>
    ...
    <header id="header"> <hgroup>
            ...
            <h2 class="section_title">Quản Lý Thể Loại</h2>
    ...
    <section id="secondary_bar">
        ...
        <div class="breadcrumbs_container">
            <article class="breadcrumbs"> <a href="index.html">Trang
                    Admin</a>
                <div class="breadcrumb_divider"></div>
                <a class="current">Quản Lý Thể Loại</a></article>
        </div>
    </section>
    ...
    <aside id="sidebar" class="column">
        ...
        <ul class="toggle">
            ...
            <li class="icn_categories"><a href="#">Quản Lý Sản Phẩm</a></li>
            <li class="icn_tags"><a href="#">Sửa Sản Phẩm</a></li>
        </ul>
        <h3>Users</h3>
        <ul class="toggle">
    ...
    <section id="main" class="column">
                    ...
                    <table class="tablesorter" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=c.getMa_danh_muc()%></td>
                                <td><%=c.getTen_danh_muc()%></td>
                                <td><%=c.getDanh_muc_cha()%></td>

                                


                                <td><a href="sua_the_loai.jsp?ma_danh_muc=<%=c.getMa_danh_muc() %>"><img
                                            src="images/icn_edit.png" alt="" title="" /></a></td>
                                <td><a href="XoaTheLoai?ma_danh_muc=<%=c.getMa_danh_muc() %>"><img
        ...
        %> <article class="module width_full"> <header>
            ...
            <div class="module_content">
                ...
                <form action="Them_the_loai" method="post">
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <textarea rows="9" class="form_textarea" name="danh_muc_cha"></textarea>
                    </fieldset>
                    <div class="clear"></div>
            </div>
            <footer>
