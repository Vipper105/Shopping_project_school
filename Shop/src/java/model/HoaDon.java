...
public class HoaDon {
    ...
    public HoaDon(String ma_hoa_don, User tai_khoan, String dia_chi_giao_hang, String phuong_thuc_thanh_toan, Timestamp ngay_mua_hang, int tinh_trang_don_hang) {
    ...
    public User getTai_khoan() {
        return tai_khoan;
    }

    public void setTai_khoan(User tai_khoan) {
        this.tai_khoan = tai_khoan;
    }
