...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/menu_animation_beautiful.css" type="text/css" media="screen"/>
        <style>
			body{
    ...
    <body>
		<div class="content">
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li>
					<a href="#">
                                            <img src="images/0-thiet-ke-logo-shop-thiet-ke-bang-hieu-shop (1).png" alt=""/>
						<span class="sdt_active"></span>
						<span class="sdt_wrap">
